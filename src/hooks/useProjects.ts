...
export function useProjects(filters?: {
  ...
  // 1. SWR 키 설정 (필터 값이 바뀌면 SWR이 자동으로 데이터를 다시 불러옵니다)
  // 키를 배열로 만들면 필터가 바뀔 때마다 개별적으로 캐싱됩니다.
  const swrKey = [
    "/api/projects",
